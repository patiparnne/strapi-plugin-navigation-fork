  ...
  return (
    <Grid.Root gap={5} paddingTop={1} paddingBottom={1}>
      <Grid.Item alignItems="flex-start" key="title" col={12}>
        ...
        <Grid.Root gap={5}>
          <Grid.Item alignItems="flex-start" col={6} s={12}>
            <Field
              name="i18n.locale"
              label={formatMessage(
            ...
            >
              <SingleSelect
                name="i18n.locale"
                onChange={(value: string | number) => setItemLocaleCopyValue(String(value))}
          ...
          {canUpdate && (
            <Grid.Item alignItems="flex-start" col={6} s={12} paddingTop={6}>
              <Box>
                <Button
                  variant="tertiary"
