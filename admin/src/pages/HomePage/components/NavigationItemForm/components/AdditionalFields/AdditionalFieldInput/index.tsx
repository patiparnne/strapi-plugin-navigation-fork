    ...
    case 'string':
      return (
        <TextInput
          ...
          value={typeof value === 'string' ? value : DEFAULT_STRING_VALUE}
        />
      );
    case 'select':
      return field.multi ? (
        <MultiSelect
          ...
          onChange={(values: string[]) =>
            onChangeEnhancer(defaultInputProps.name, values, onChange)
          }
        ...
        <SingleSelect
          ...
          onChange={(value: string | number) =>
            onChangeEnhancer(defaultInputProps.name, String(value), onChange)
          }
          value={isNil(value) ? undefined : (value as string)}
        >
          {field.options.map((option, index) => (
