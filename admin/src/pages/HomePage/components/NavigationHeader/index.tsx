            ...
            <Box>
              ...
              >
                  ...
                  <Field.Root width="100%">
                    <SingleSelect
                      ...
                      onChange={(value: string | number) => {
                        const nextDocumentId = String(value);
                ...
                {hasLocalizations ? (
                  <Grid.Item col={2}>
                    <SingleSelect
                      ...
                      onChange={(value: string | number) => handleLocalizationSelection(String(value))}
                      value={currentLocale}
                      size="S"
                    >
                ...
                {canUpdate && (
                  <Grid.Item col={3}>
                    <Button
                      onClick={() => handleSave(undefined as any)}
                ...
                {configQuery.data?.isCacheEnabled && (
                  <Grid.Item col={3}>
                    <Button
                      onClick={() => handleCachePurge(undefined as any)}
                      startIcon={submitIcon}
                      variant="danger"
                      type="submit"
                      fullWidth
